...
<body>
    <div class="slideshow-container">
        ...
        <img class="img active" src="../Mercedes-Benz/E-class/karavan/e.jfif" alt="Slide 1">
        <img class="img" src="../Mercedes-Benz/E-class/karavan/e1.jfif" alt="Slide 2">
        <img class="img" src="../Mercedes-Benz/E-class/karavan/e2.jfif" alt="Slide 3">
        <img class="img" src="../Mercedes-Benz/E-class/karavan/e3.jfif" alt="Slide 4">
        <img class="img" src="../Mercedes-Benz/E-class/karavan/e4.jfif" alt="Slide 5">
        <img class="img" src="../Mercedes-Benz/E-class/karavan/e5.jfif" alt="Slide 6">
        <img class="img" src="../Mercedes-Benz/E-class/karavan/e6.jfif" alt="Slide 7">
        <img class="img" src="../Mercedes-Benz/E-class/karavan/e7.jfif" alt="Slide 8">
        <img class="img" src="../Mercedes-Benz/E-class/karavan/e8.jfif" alt="Slide 8">
