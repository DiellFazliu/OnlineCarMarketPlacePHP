...
<body>
    <div class="slideshow-container">
        ...
        <img class="img active" src="../Rolls Royce/dawn/r.jpg" alt="Slide 1">
        <img class="img" src="../Rolls Royce/dawn/r1.jpg" alt="Slide 2">
        <img class="img" src="../Rolls Royce/dawn/r2.jpg" alt="Slide 3">
        <img class="img" src="../Rolls Royce/dawn/r3.jpg" alt="Slide 4">
        <img class="img" src="../Rolls Royce/dawn/r4.jpg" alt="Slide 5">
        <img class="img" src="../Rolls Royce/dawn/r5.jpg" alt="Slide 6">
        <img class="img" src="../Rolls Royce/dawn/r6.jpg" alt="Slide 7">
        <img class="img" src="../Rolls Royce/dawn/r7.jpg" alt="Slide 8">
        <img class="img" src="../Rolls Royce/dawn/r8.jpg" alt="Slide 9">
        <img class="img" src="../Rolls Royce/dawn/r9.jpg" alt="Slide 10">
        <img class="img" src="../Rolls Royce/dawn/r10.jpg" alt="Slide 11">
        <img class="img" src="../Rolls Royce/dawn/r11.jpg" alt="Slide 12">
