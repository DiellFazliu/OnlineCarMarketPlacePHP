...
<body>
    ...
    <p id="titulli">BMW M8 Gran Coupe</p>
    <div class="logos">
        <div>
    ...
    <div class="container">
        <div class="left-content">
            <div class="left-content-up">
                <div class="slideshow">
                    <img src="../BMW/M8/normal/b.jpg" alt="Slide 1" class="active" onclick="openSlide(1)">
                    <img src="../BMW/M8/normal/b1.jpg " alt="Slide 2" onclick="openSlide(2)">
                    <img src="../BMW/M8/normal/b2.jpg " alt="Slide 3" onclick="openSlide(3)">
                    <img src="../BMW/M8/normal/b3.jpg " alt="Slide 4" onclick="openSlide(4)">
                    <img src="../BMW/M8/normal/b4.jpg " alt="Slide 5" onclick="openSlide(5)">
                    <img src="../BMW/M8/normal/b5.jpg " alt="Slide 6" onclick="openSlide(6)">
                    <img src="../BMW/M8/normal/b6.jpg " alt="Slide 7" onclick="openSlide(7)">
                    <img src="../BMW/M8/normal/b7.jpg " alt="Slide 8" onclick="openSlide(8)">
                    <img src="../BMW/M8/normal/b8.jpg " alt="Slide 9" onclick="openSlide(9)">
                    <img src="../BMW/M8/normal/b9.jpg " alt="Slide 10" onclick="openSlide(10)">
                    <img src="../BMW/M8/normal/b10.jpg " alt="Slide 11" onclick="openSlide(11)">
                </div>
                
                <script>
                    function openSlide(slideNumber) {
                        const baseUrl = "M8-slideshow.html";
            ...
            <div class="left-content-down">
                <div class="right">
                    <ul>
                        <li><strong>Motor:</strong> <span>4.4 V8</span></li>
                        <li><strong>Fuqia:</strong> <span>625 Hp</span></li>
                        ...
                        <li><strong>Kilometrazhi:</strong> <span>8500 km</span></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="right-content">
            <div class="right-content-up">
                <p><b>BMW M8 Gran Coupe</b> është një sedan sportiv luksoz që ofron performancë ekstreme dhe stil të pakrahasueshëm. Ja një përshkrim i shkurtër:

                    <br><br><b>Performanca:</b><br>
                     Motori: 4.4L V8 Twin-turbocharged me 625 hp dhe 750 Nm moment rrotullimi.
                     Transmetimi: Automatik 8-shpejtësi M Steptronic, me sistem të avancuar all-wheel drive (M xDrive).
                     Shpejtësia: Arrin 0-100 km/h në vetëm 3.2 sekonda.
                    <br><br><b>Dizajni:</b><br>
                     Pamja e jashtme: Grilë frontale e theksuar, dritat Laser Light dhe elementë aerodinamikë që reflektojnë një pamje sportive dhe elegante.
                     Pamja e brendshme: Kabinë luksoze me materiale premium, sedilje sportive me funksion masazhi, dhe ekran M-specific për komandat dhe infotainment.
                    <br><br><b>Karakteristikat:</b><br>
                     Teknologji: Apple CarPlay, Android Auto, dhe sistem audio Bowers & Wilkins Diamond Surround për një përvojë të klasit të lartë.
                     Siguria: BMW Driving Assistant Professional, Active Cruise Control, dhe Night Vision për një përvojë të sigurt dhe të avancuar në vozitje.
                 </p>
            </div>
