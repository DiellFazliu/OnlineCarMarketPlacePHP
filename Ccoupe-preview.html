...
<body>
    ...
    <p id="titulli">Mercedes-Benz C-Class Coupe 2023</p>
    <div class="logos">
        <div>
    ...
    <div class="container">
        <div class="left-content">
            <div class="left-content-up">
                <div class="slideshow">
                    <img src="../Mercedes-Benz/C-class/coupe/c.jfif" alt="Slide 1" class="active" onclick="openSlide(1)">
                    <img src="../Mercedes-Benz/C-class/coupe/c1.jfif " alt="Slide 2" onclick="openSlide(2)">
                    <img src="../Mercedes-Benz/C-class/coupe/c2.jfif " alt="Slide 3" onclick="openSlide(3)">
                    <img src="../Mercedes-Benz/C-class/coupe/c3.jfif " alt="Slide 4" onclick="openSlide(4)">
                    <img src="../Mercedes-Benz/C-class/coupe/c4.jfif " alt="Slide 5" onclick="openSlide(5)">
                    <img src="../Mercedes-Benz/C-class/coupe/c5.jfif " alt="Slide 6" onclick="openSlide(6)">
                    <img src="../Mercedes-Benz/C-class/coupe/c6.jfif " alt="Slide 7" onclick="openSlide(7)">
                    <img src="../Mercedes-Benz/C-class/coupe/c7.jfif " alt="Slide 8" onclick="openSlide(8)">
                </div>
                
                <script>
                    function openSlide(slideNumber) {
                        const baseUrl = "Ccoupe-slideshow.html";
        ...
        <div class="right-content">
            <div class="right-content-up">
                <p><b>Mercedes-Benz C-Class Coupe 2023</b> është një coupe elegante dhe dinamike që ofron performancë të rafinuar dhe teknologji të avancuar. Ja një përshkrim i shkurtër:

                    <br><br><b>Performanca:</b><br>
                     Motori: 2.0L turbocharged 4-cilindërsh me 204 hp ose versioni AMG me deri në 408 hp (për AMG C43).
                     Transmetimi: Automatik 9-shpejtësi 9G-Tronic, me opsion për all-wheel drive (4MATIC).
                     Shpejtësia: Arrin 0-100 km/h në rreth 4.6 sekonda (për AMG C43).
                    <br><br><b>Dizajni:</b><br>
                     Pamja e jashtme: Linja elegante dhe sportive, dritat LED me dizajn të rafinuar, dhe grilë me elemente kromi që i japin një pamje moderne.
                     Pamja e brendshme: Kabinë luksoze me ekrane dixhitale të avancuara, material premium, dhe ndriçim ambiental me shumë ngjyra.
                    <br><br><b>Karakteristikat:</b><br>
                     Teknologji: Apple CarPlay, Android Auto, dhe sistem audio Burmester për një përvojë audio të shkëlqyer.
                     Siguria: Driving Assistance Package, Active Lane Keeping Assist, dhe kamera 360° për një përvojë të sigurt dhe të kontrolluar në vozitje.
                 </p>
            </div>
...
<script>
  function redirect() {
    window.location.href = "payment.html";
                    ...
                    <div class="financing">Financim 900 €/muaj</div>
                </div>
