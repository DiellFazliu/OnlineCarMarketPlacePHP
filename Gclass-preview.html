    ...
    <div class="container">
        <div class="left-content">
            <div class="left-content-up">
                <div class="slideshow">
                    <img src="../Mercedes-Benz/G-class/normal/g.jfif" alt="Slide 1" class="active" onclick="openSlide(1)">
                    <img src="../Mercedes-Benz/G-class/normal/g1.jfif " alt="Slide 2" onclick="openSlide(2)">
                    <img src="../Mercedes-Benz/G-class/normal/g2.jfif " alt="Slide 3" onclick="openSlide(3)">
                    <img src="../Mercedes-Benz/G-class/normal/g3.jfif " alt="Slide 4" onclick="openSlide(4)">
                    <img src="../Mercedes-Benz/G-class/normal/g4.jfif " alt="Slide 5" onclick="openSlide(5)">
                    <img src="../Mercedes-Benz/G-class/normal/g5.jfif " alt="Slide 6" onclick="openSlide(6)">
                    <img src="../Mercedes-Benz/G-class/normal/g6.jfif " alt="Slide 7" onclick="openSlide(7)">
                    <img src="../Mercedes-Benz/G-class/normal/g7.jfif " alt="Slide 8" onclick="openSlide(8)">
                    <img src="../Mercedes-Benz/G-class/normal/g8.jfif " alt="Slide 9" onclick="openSlide(9)">
                    <img src="../Mercedes-Benz/G-class/normal/g9.jfif " alt="Slide 10" onclick="openSlide(10)">
                    <img src="../Mercedes-Benz/G-class/normal/g10.jfif " alt="Slide 11" onclick="openSlide(11)">
                </div>
                
                <script>
                    function openSlide(slideNumber) {
                        const baseUrl = "Gclass-slideshow.html";
            ...
            <div class="left-content-down">
                <div class="right">
                    <ul>
                        ...
                        <li><strong>Kilometrazhi:</strong> <span>25000 km</span></li>
                    </ul>
                </div>
            </div>
