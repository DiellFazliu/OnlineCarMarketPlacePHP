...
<body>
    <div class="slideshow-container">
        ...
        <img class="img active" src="../BMW/M4/coupe/b.jpg" alt="Slide 1">
        <img class="img" src="../BMW/M4/coupe/b1.jpg" alt="Slide 2">
        <img class="img" src="../BMW/M4/coupe/b2.jpg" alt="Slide 3">
        <img class="img" src="../BMW/M4/coupe/b3.jpg" alt="Slide 4">
        <img class="img" src="../BMW/M4/coupe/b4.jpg" alt="Slide 5">
        <img class="img" src="../BMW/M4/coupe/b5.jpg" alt="Slide 6">
        <img class="img" src="../BMW/M4/coupe/b6.jpg" alt="Slide 7">
        <img class="img" src="../BMW/M4/coupe/b7.jpg" alt="Slide 8">
        <img class="img" src="../BMW/M4/coupe/b8.jpg" alt="Slide 9">
        <img class="img" src="../BMW/M4/coupe/b9.jpg" alt="Slide 10">
        <img class="img" src="../BMW/M4/coupe/b10.jpg" alt="Slide 11">
        <img class="img" src="../BMW/M4/coupe/b11.jpg" alt="Slide 12">
        <img class="img" src="../BMW/M4/coupe/b12.jpg" alt="Slide 13">
