...
<body>
    <div class="slideshow-container">
        ...
        <img class="img active" src="../BMW/M4/m4/b.jpg" alt="Slide 1">
        <img class="img" src="../BMW/M4/m4/b1.jpg" alt="Slide 2">
        <img class="img" src="../BMW/M4/m4/b2.jpg" alt="Slide 3">
        <img class="img" src="../BMW/M4/m4/b3.jpg" alt="Slide 4">
        <img class="img" src="../BMW/M4/m4/b4.jpg" alt="Slide 5">
        <img class="img" src="../BMW/M4/m4/b5.jpg" alt="Slide 6">
        <img class="img" src="../BMW/M4/m4/b6.jpg" alt="Slide 7">
        <img class="img" src="../BMW/M4/m4/b7.jpg" alt="Slide 8">
        <img class="img" src="../BMW/M4/m4/b8.jpg" alt="Slide 9">
        <img class="img" src="../BMW/M4/m4/b9.jpg" alt="Slide 10">
        <img class="img" src="../BMW/M4/m4/b10.jpg" alt="Slide 11">
        <img class="img" src="../BMW/M4/m4/b11.jpg" alt="Slide 12">
        <img class="img" src="../BMW/M4/m4/b12.jpg" alt="Slide 13">
        <img class="img" src="../BMW/M4/m4/b13.jpg" alt="Slide 14">
        <img class="img" src="../BMW/M4/m4/b14.jpg" alt="Slide 15">
