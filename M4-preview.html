    ...
    <div class="container">
        <div class="left-content">
            <div class="left-content-up">
                <div class="slideshow">
                    <img src="../BMW/M4/m4/b.jpg" alt="Slide 1" class="active" onclick="openSlide(1)">
                    <img src="../BMW/M4/m4/b1.jpg" alt="Slide 2" onclick="openSlide(2)">
                    <img src="../BMW/M4/m4/b2.jpg" alt="Slide 3" onclick="openSlide(3)">
                    <img src="../BMW/M4/m4/b3.jpg" alt="Slide 4" onclick="openSlide(4)">
                    <img src="../BMW/M4/m4/b4.jpg" alt="Slide 5" onclick="openSlide(5)">
                    <img src="../BMW/M4/m4/b5.jpg" alt="Slide 6" onclick="openSlide(6)">
                    <img src="../BMW/M4/m4/b6.jpg" alt="Slide 7" onclick="openSlide(7)">
                    <img src="../BMW/M4/m4/b7.jpg" alt="Slide 8" onclick="openSlide(8)">
                    <img src="../BMW/M4/m4/b8.jpg" alt="Slide 9" onclick="openSlide(9)">
                    <img src="../BMW/M4/m4/b9.jpg" alt="Slide 10" onclick="openSlide(10)">
                    <img src="../BMW/M4/m4/b10.jpg" alt="Slide 11" onclick="openSlide(11)">
                    <img src="../BMW/M4/m4/b11.jpg" alt="Slide 12" onclick="openSlide(12)">
                    <img src="../BMW/M4/m4/b12.jpg" alt="Slide 13" onclick="openSlide(13)">
                    <img src="../BMW/M4/m4/b13.jpg" alt="Slide 14" onclick="openSlide(14)">
                    <img src="../BMW/M4/m4/b14.jpg" alt="Slide 15" onclick="openSlide(15)">
                </div>
                
                <script>
                    function openSlide(slideNumber) {
                        const baseUrl = "M4-slideshow.html";
        ...
        <div class="right-content">
            <div class="right-content-up">
                <p><b>BMW G82 M4 2022</b> është një coupe sportiv i jashtëzakonshëm që ofron performancë të papërshkrueshme dhe një dizajn dinamik. Ja një përshkrim i shkurtër:
                    ...
                    <br><br><b>Performanca:</b><br>
                     ...
                     Shpejtësia: Arrin 0-100 km/h në 3.8 sekonda (për versionin xDrive).
                    <br><br><b>Dizajni:</b><br>
                     ...
                     Pamja e brendshme: Kabinë moderne dhe sportive, me sedilje të larta cilësie dhe ekran të avancuar për infotainment dhe komandë.
                    <br><br><b>Karakteristikat:</b><br>
                     Teknologji: Apple CarPlay, Android Auto, dhe mundësi për sistemin audio Harman Kardon.
                     Siguria: M Drive, Dynamic Traction Control, dhe asistencë për siguri të lartë dhe përvojë të jashtëzakonshme drejtimi.
                 </p>
            </div>
...
<script>
  function redirect() {
    window.location.href = "payment.html";
                    ...
                    <div class="financing">Financim 1450 €/muaj</div>
                </div>
