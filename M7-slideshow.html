...
<body>
    <div class="slideshow-container">
        ...
        <img class="img active" src="../BMW/M7/m sport/b.jpg" alt="Slide 1">
        <img class="img" src="../BMW/M7/m sport/b1.jpg" alt="Slide 2">
        <img class="img" src="../BMW/M7/m sport/b2.jpg" alt="Slide 3">
        <img class="img" src="../BMW/M7/m sport/b3.jpg" alt="Slide 4">
        <img class="img" src="../BMW/M7/m sport/b4.jpg" alt="Slide 5">
        <img class="img" src="../BMW/M7/m sport/b5.jpg" alt="Slide 6">
        <img class="img" src="../BMW/M7/m sport/b6.jpg" alt="Slide 7">
        <img class="img" src="../BMW/M7/m sport/b7.jpg" alt="Slide 8">
        <img class="img" src="../BMW/M7/m sport/b8.jpg" alt="Slide 9">
        <img class="img" src="../BMW/M7/m sport/b9.jpg" alt="Slide 10">
        <img class="img" src="../BMW/M7/m sport/b10.jpg" alt="Slide 11">
        <img class="img" src="../BMW/M7/m sport/b11.jpg" alt="Slide 12">
        <img class="img" src="../BMW/M7/m sport/b12.jpg" alt="Slide 13">
