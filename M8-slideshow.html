...
<body>
    <div class="slideshow-container">
        ...
        <img class="img active" src="../BMW/M8/normal/b.jpg" alt="Slide 1">
        <img class="img" src="../BMW/M8/normal/b1.jpg" alt="Slide 2">
        <img class="img" src="../BMW/M8/normal/b2.jpg" alt="Slide 3">
        <img class="img" src="../BMW/M8/normal/b3.jpg" alt="Slide 4">
        <img class="img" src="../BMW/M8/normal/b4.jpg" alt="Slide 5">
        <img class="img" src="../BMW/M8/normal/b5.jpg" alt="Slide 6">
        <img class="img" src="../BMW/M8/normal/b6.jpg" alt="Slide 7">
        <img class="img" src="../BMW/M8/normal/b7.jpg" alt="Slide 8">
        <img class="img" src="../BMW/M8/normal/b8.jpg" alt="Slide 9">
        <img class="img" src="../BMW/M8/normal/b9.jpg" alt="Slide 10">
        <img class="img" src="../BMW/M8/normal/b10.jpg" alt="Slide 11">
