...
<body>
    <div class="slideshow-container">
        ...
        <img class="img active" src="../Mercedes-Benz/E-class/coupe/e.jfif" alt="Slide 1">
        <img class="img" src="../Mercedes-Benz/E-class/coupe/e1.jfif" alt="Slide 2">
        <img class="img" src="../Mercedes-Benz/E-class/coupe/e2.jfif" alt="Slide 3">
        <img class="img" src="../Mercedes-Benz/E-class/coupe/e3.jfif" alt="Slide 4">
        <img class="img" src="../Mercedes-Benz/E-class/coupe/e4.jfif" alt="Slide 5">
        <img class="img" src="../Mercedes-Benz/E-class/coupe/e5.jfif" alt="Slide 6">
        <img class="img" src="../Mercedes-Benz/E-class/coupe/e6.jfif" alt="Slide 7">
        <img class="img" src="../Mercedes-Benz/E-class/coupe/e7.jfif" alt="Slide 8">
        <img class="img" src="../Mercedes-Benz/E-class/coupe/e8.jfif" alt="Slide 9">
