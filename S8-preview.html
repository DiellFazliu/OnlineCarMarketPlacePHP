    ...
    <div class="container">
        <div class="left-content">
            <div class="left-content-up">
                <div class="slideshow">
                    <img src="../Audi/A8/s8/a.jfif" alt="Slide 1" class="active" onclick="openSlide(1)">
                    <img src="../Audi/A8/s8/a.jfif" alt="Slide 2" onclick="openSlide(2)">
                    <img src="../Audi/A8/s8/a2.jfif" alt="Slide 3" onclick="openSlide(3)">
                    <img src="../Audi/A8/s8/a3.jfif" alt="Slide 4" onclick="openSlide(4)">
                    <img src="../Audi/A8/s8/a4.jfif" alt="Slide 5" onclick="openSlide(5)">
                    <img src="../Audi/A8/s8/a5.jfif" alt="Slide 6" onclick="openSlide(6)">
                    <img src="../Audi/A8/s8/a6.jfif" alt="Slide 7" onclick="openSlide(7)">
                    <img src="../Audi/A8/s8/a7.jfif" alt="Slide 8" onclick="openSlide(8)">
                    <img src="../Audi/A8/s8/a8.jfif" alt="Slide 9" onclick="openSlide(9)">
                    <img src="../Audi/A8/s8/a9.jfif" alt="Slide 10" onclick="openSlide(10)">
                </div>
                
                <script>
                    function openSlide(slideNumber) {
                        const baseUrl = "S8-slideshow.html";
        ...
        <div class="right-content">
            <div class="right-content-up">
                <p><b>Audi S8 420 kW</b> është një sedan sportiv luksoz që ofron një kombinim të jashtëzakonshëm të performancës, luksit dhe teknologjisë. Ja një përshkrim i shkurtër:

                    <br><br><b>Performanca:</b><br>
                     Motori: 4.0L V8 TFSI me 420 kW (571 hp) dhe 800 Nm moment rrotullimi.
                     Transmetimi: Automatik 8-shpejtësi Tiptronic, me mundësi për all-wheel drive (Quattro).
                     Shpejtësia: Arrin 0-100 km/h në 3.8 sekonda.
                    <br><br><b>Dizajni:</b><br>
                     Pamja e jashtme: Grilë frontale Singleframe, dritat Matrix LED dhe linja aerodinamike që i japin një pamje sportive dhe elegante.
                     Pamja e brendshme: Kabinë luksoze me materiale premium, ekran MMI Touch plus opsion për Virtual Cockpit për një përvojë të avancuar dhe të sofistikuar.
                    <br><br><b>Karakteristikat:</b><br>
                     Teknologji: Apple CarPlay, Android Auto, dhe mundësi për sistemin audio Bang & Olufsen.
                     Siguria: Audi Pre-Sense, Lane Assist, Adaptive Cruise Control dhe Park Assist për një përvojë sigurie të lartë dhe asistencë të avancuar në vozitje.
                </p>
            </div>
