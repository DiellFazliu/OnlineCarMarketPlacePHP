...
<body>
    ...
    <p id="titulli">Mercedes-Benz S-Class Sedan 2022</p>
    <div class="logos">
        <div>
    ...
    <div class="container">
        <div class="left-content">
            <div class="left-content-up">
                <div class="slideshow">
                    <img src="../Mercedes-Benz/S-class/normal/s.jfif" alt="Slide 1" class="active" onclick="openSlide(1)">
                    <img src="../Mercedes-Benz/S-class/normal/s1.jfif " alt="Slide 2" onclick="openSlide(2)">
                    <img src="../Mercedes-Benz/S-class/normal/s2.jfif " alt="Slide 3" onclick="openSlide(3)">
                    <img src="../Mercedes-Benz/S-class/normal/s3.jfif " alt="Slide 4" onclick="openSlide(4)">
                    <img src="../Mercedes-Benz/S-class/normal/s4.jfif " alt="Slide 5" onclick="openSlide(5)">
                    <img src="../Mercedes-Benz/S-class/normal/s5.jfif " alt="Slide 6" onclick="openSlide(6)">
                    <img src="../Mercedes-Benz/S-class/normal/s6.jfif " alt="Slide 7" onclick="openSlide(7)">
                    <img src="../Mercedes-Benz/S-class/normal/s7.jfif " alt="Slide 8" onclick="openSlide(8)">
                    <img src="../Mercedes-Benz/S-class/normal/s8.jfif " alt="Slide 9" onclick="openSlide(9)">
                    <img src="../Mercedes-Benz/S-class/normal/s9.jfif " alt="Slide 10" onclick="openSlide(10)">
                    <img src="../Mercedes-Benz/S-class/normal/s10.jfif " alt="Slide 11" onclick="openSlide(11)">
                </div>
                
                <script>
                    function openSlide(slideNumber) {
                        const baseUrl = "Ssedan-slideshow.html";
            ...
            <div class="left-content-down">
                <div class="right">
                    <ul>
                        ...
                        <li><strong>Kilometrazhi:</strong> <span>22000 km</span></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="right-content">
            <div class="right-content-up">
                <p><b>Mercedes-Benz S-Class Sedan 2022</b> është një sedan luksoz që ofron performancë të jashtëzakonshme dhe një eksperiencë të paarsyeshme komoditeti. Ja një përshkrim i shkurtër:

                    <br><br><b>Performanca:</b><br>
                     Motori: 4.0L V8 Biturbo me 612 hp dhe 850 Nm moment rrotullimi.
                     Transmetimi: Automatik 9-shpejtësi 9G-TRONIC, me mundësi për all-wheel drive (4MATIC).
                     Shpejtësia: Arrin 0-100 km/h në 4.4 sekonda.
                    <br><br><b>Dizajni:</b><br>
                     Pamja e jashtme: Grilë frontale elegante, linja të pastra dhe drita LED për një pamje moderne dhe sofistikuar.
                     Pamja e brendshme: Kabinë luksoze me materiale premium, sistem MBUX, dhe opsion për Virtual Cockpit për një përvojë të avancuar.
                    <br><br><b>Karakteristikat:</b><br>
                     Teknologji: Apple CarPlay, Android Auto, dhe mundësi për sistemin audio Burmester 3D Surround për një tingull të pashembullt.
                     Siguria: Active Brake Assist, Lane Keeping Assist, dhe Park Assist për siguri maksimale dhe asistencë të avancuar në vozitje.
                 </p>
            </div>
...
<script>
  function redirect() {
    window.location.href = "payment.html";
                    ...
                    <div class="financing">Financim 2500 €/muaj</div>
                </div>
