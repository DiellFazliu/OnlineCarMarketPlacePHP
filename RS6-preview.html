    ...
    <div class="container">
        <div class="left-content">
            <div class="left-content-up">
                <div class="slideshow">
                    <img src="../Audi/A6/rs6/a.jfif" alt="Slide 1" class="active" onclick="openSlide(1)">
                    <img src="../Audi/A6/rs6/a1.jfif" alt="Slide 2" onclick="openSlide(2)">
                    <img src="../Audi/A6/rs6/a2.jfif" alt="Slide 3" onclick="openSlide(3)">
                    <img src="../Audi/A6/rs6/a3.jfif" alt="Slide 4" onclick="openSlide(4)">
                    <img src="../Audi/A6/rs6/a4.jfif" alt="Slide 5" onclick="openSlide(5)">
                    <img src="../Audi/A6/rs6/a5.jfif" alt="Slide 6" onclick="openSlide(6)">
                    <img src="../Audi/A6/rs6/a6.jfif" alt="Slide 7" onclick="openSlide(7)">
                    <img src="../Audi/A6/rs6/a7.jfif" alt="Slide 8" onclick="openSlide(8)">
                    <img src="../Audi/A6/rs6/a8.jfif" alt="Slide 9" onclick="openSlide(9)">
                    <img src="../Audi/A6/rs6/a9.jfif" alt="Slide 10" onclick="openSlide(10)">
                    <img src="../Audi/A6/rs6/a10.jfif" alt="Slide 11" onclick="openSlide(11)">
                    <img src="../Audi/A6/rs6/a11.jfif" alt="Slide 12" onclick="openSlide(12)">
                    <img src="../Audi/A6/rs6/a12.jfif" alt="Slide 13" onclick="openSlide(13)">
                    <img src="../Audi/A6/rs6/a13.jfif" alt="Slide 14" onclick="openSlide(14)">
                    <img src="../Audi/A6/rs6/a14.jfif" alt="Slide 15" onclick="openSlide(15)">
                </div>
                
                <script>
                    function openSlide(slideNumber) {
                        const baseUrl = "RS6-slideshow.html";
        ...
        <div class="right-content">
            <div class="right-content-up">
                <p><b>Audi RS6 Avant 2021</b> është një model i jashtëzakonshëm sportiv që kombinon performancën e nivelit të lartë me fleksibilitetin dhe hapësirën e një automjeti familjar. Ja një përshkrim i shkurtër:
                    ...
                    <br><br><b>Dizajni:</b><br>
                     Pamja e jashtme: Grilë frontale më të gjërë, dritat Matrix LED, dhe elementë aerodinamikë që i japin një pamje të fuqishme dhe të sofistikuar.
                     Pamja e brendshme: Sallon i shtrenjtë dhe i modernizuar, me detaje alumini dhe një ekran MMI Touch plus opsion për Virtual Cockpit.
                    <br><br><b>Karakteristikat:</b><br>
                     Teknologji: Apple CarPlay, Android Auto, dhe mundësi për sistemin audio Bang & Olufsen.
                     Siguria: Audi Pre-Sense, Lane Assist, dhe Adaptive Cruise Control për një përvojë sigurie të avancuar.
                 </p>
            </div>
