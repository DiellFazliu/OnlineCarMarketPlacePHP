...
<button onclick="openPopup('add_car.php', 'Add Car', 600, 700)">Add New Car</button>
    ...
    <tr>
        ...
        <td>
            <form method="POST" style="display:inline-block;" onsubmit="return confirm('Are you sure to delete this car?');">
                ...
                <button onclick="openPopup('edit_car.php?car_id=<?= $car['car_id'] ?>', 'Edit Car', 600, 700)">Edit Car</button>
