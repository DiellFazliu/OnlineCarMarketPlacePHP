...
<body>
    <div class="slideshow-container">
        ...
        <img class="img active" src="../Rolls Royce/wraith/r.jpg" alt="Slide 1">
        <img class="img" src="../Rolls Royce/wraith/r1.jpg" alt="Slide 2">
        <img class="img" src="../Rolls Royce/wraith/r2.jpg" alt="Slide 3">
        <img class="img" src="../Rolls Royce/wraith/r3.jpg" alt="Slide 4">
        <img class="img" src="../Rolls Royce/wraith/r4.jpg" alt="Slide 5">
        <img class="img" src="../Rolls Royce/wraith/r5.jpg" alt="Slide 6">
        <img class="img" src="../Rolls Royce/wraith/r6.jpg" alt="Slide 7">
        <img class="img" src="../Rolls Royce/wraith/r7.jpg" alt="Slide 8">
        <img class="img" src="../Rolls Royce/wraith/r8.jpg" alt="Slide 9">
