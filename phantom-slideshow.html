...
<body>
    <div class="slideshow-container">
        ...
        <img class="img active" src="../Rolls Royce/phantom/r.jpg" alt="Slide 1">
        <img class="img" src="../Rolls Royce/phantom/r1.jpg" alt="Slide 2">
        <img class="img" src="../Rolls Royce/phantom/r2.jpg" alt="Slide 3">
        <img class="img" src="../Rolls Royce/phantom/r3.jpg" alt="Slide 4">
        <img class="img" src="../Rolls Royce/phantom/r4.jpg" alt="Slide 5">
        <img class="img" src="../Rolls Royce/phantom/r5.jpg" alt="Slide 6">
        <img class="img" src="../Rolls Royce/phantom/r6.jpg" alt="Slide 7">
        <img class="img" src="../Rolls Royce/phantom/r7.jpg" alt="Slide 8">
        <img class="img" src="../Rolls Royce/phantom/r8.jpg" alt="Slide 9">
        <img class="img" src="../Rolls Royce/phantom/r9.jpg" alt="Slide 10">
        <img class="img" src="../Rolls Royce/phantom/r10.jpg" alt="Slide 11">
