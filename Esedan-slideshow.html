...
<body>
    <div class="slideshow-container">
        ...
        <img class="img active" src="../Mercedes-Benz/E-class/normal/e.jfif" alt="Slide 1">
        <img class="img" src="../Mercedes-Benz/E-class/normal/e1.jfif" alt="Slide 2">
        <img class="img" src="../Mercedes-Benz/E-class/normal/e2.jfif" alt="Slide 3">
        <img class="img" src="../Mercedes-Benz/E-class/normal/e3.jfif" alt="Slide 4">
        <img class="img" src="../Mercedes-Benz/E-class/normal/e4.jfif" alt="Slide 5">
        <img class="img" src="../Mercedes-Benz/E-class/normal/e5.jfif" alt="Slide 6">
        <img class="img" src="../Mercedes-Benz/E-class/normal/e6.jfif" alt="Slide 7">
        <img class="img" src="../Mercedes-Benz/E-class/normal/e7.jfif" alt="Slide 8">
