...
<body>
    <div class="logo-wrapper">
            <a href="project.html"><img src="logo1.png" class="logo" style="padding-top: 4px;"></a>
    ...
    <form onsubmit="validate(event)">
        ...
        <div id="passwordError" class="error-message">Password must be 8-16 characters long.</div>
        ...
        <div class="sign-up" style="text-shadow: 2px 2px 4px rgba(255, 255, 255, 0.5);">
            Don't have an account? <a href="/register.html"> <br> Sign up</a>
        </div>
    </form>
    ...
    <script>
        ...
        document.querySelectorAll(".social div").forEach(icon => {
            icon.addEventListener("click", event => {
                const platformName = event.currentTarget.classList.contains("fb")
                    ? "Facebook"
                    : event.currentTarget.classList.contains("gh")
                        ? "Github"
                        : "Google";
                
                modal.querySelector("h3").textContent = `Login with ${platformName}`;
        ...
        document.getElementById("modal-signup-button").addEventListener("click", event => {
            ...
            if (!modalUsername) {
                ...
                modalInvalid = true;
            } else if (!modalUsername.includes(".")) {
