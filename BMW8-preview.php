...
<body>
    ...
    <p id="titulli">BMW 8 Series Coupe 530 hp</p>
    <div class="logos">
        <div>
    ...
    <div class="container">
        <div class="left-content">
            <div class="left-content-up">
                <div class="slideshow">
                    <img src="../BMW/M8/coupe/b.jpg" alt="Slide 1" class="active" onclick="openSlide(1)">
                    <img src="../BMW/M8/coupe/b1.jpg " alt="Slide 2" onclick="openSlide(2)">
                    <img src="../BMW/M8/coupe/b2.jpg " alt="Slide 3" onclick="openSlide(3)">
                    <img src="../BMW/M8/coupe/b3.jpg " alt="Slide 4" onclick="openSlide(4)">
                    <img src="../BMW/M8/coupe/b4.jpg " alt="Slide 5" onclick="openSlide(5)">
                    <img src="../BMW/M8/coupe/b5.jpg " alt="Slide 6" onclick="openSlide(6)">
                    <img src="../BMW/M8/coupe/b6.jpg " alt="Slide 7" onclick="openSlide(7)">
                    <img src="../BMW/M8/coupe/b7.jpg " alt="Slide 8" onclick="openSlide(8)">
                    <img src="../BMW/M8/coupe/b8.jpg " alt="Slide 9" onclick="openSlide(9)">
                    <img src="../BMW/M8/coupe/b9.jpg " alt="Slide 10" onclick="openSlide(10)">
                    <img src="../BMW/M8/coupe/b10.jpg " alt="Slide 11" onclick="openSlide(11)">
                    <img src="../BMW/M8/coupe/b11.jpg " alt="Slide 12" onclick="openSlide(12)">
                </div>
                
                <script>
                    function openSlide(slideNumber) {
                        const baseUrl = "BMW8-slideshow.html";
            ...
            <div class="left-content-down">
                <div class="right">
                    <ul>
                        ...
                        <li><strong>Fuqia:</strong> <span>530 Hp</span></li>
        ...
        <div class="right-content">
            <div class="right-content-up">
                <p><b>BMW 8 Series Coupe 530 hp</b> është një coupe luksoz dhe sportiv që kombinon performancën e fuqishme me dizajnin elegant. Ja një përshkrim i shkurtër:

                    <br><br><b>Performanca:</b><br>
                     Motori: 4.4L V8 Twin-turbocharged me 530 hp dhe 750 Nm moment rrotullimi.
                     Transmetimi: Automatik 8-shpejtësi Steptronic, me mundësi për all-wheel drive (xDrive).
                     Shpejtësia: Arrin 0-100 km/h në 3.9 sekonda.
                    <br><br><b>Dizajni:</b><br>
                     Pamja e jashtme: Grilë frontale e rafinuar, dritat Laser Light, dhe linja aerodinamike për një pamje sportive dhe elegante.
                     Pamja e brendshme: Kabinë luksoze me materiale premium, ekran të dyfishtë për infotainment dhe komandat, si dhe sedilje sportive të rregullueshme.
                    <br><br><b>Karakteristikat:</b><br>
                     Teknologji: Apple CarPlay, Android Auto, dhe sistem audio Bowers & Wilkins Diamond për një përvojë të jashtëzakonshme të dëgjimit.
                     Siguria: BMW Driving Assistant Professional, Parking Assistant, dhe Surround View Camera për një nivel të lartë sigurie dhe asistencë në drejtim.
                 </p>
            </div>
