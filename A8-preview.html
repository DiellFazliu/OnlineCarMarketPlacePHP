...
<body>
    ...
    <p id="titulli">Audi A8 L 55 TFSI</p>
    <div class="logos">
        <div>
    ...
    <div class="container">
        <div class="left-content">
            <div class="left-content-up">
                <div class="slideshow">
                    <img src="../Audi/A8/normal/a.jfif" alt="Slide 1" class="active" onclick="openSlide(1)">
                    <img src="../Audi/A8/normal/a.jfif" alt="Slide 2" onclick="openSlide(2)">
                    <img src="../Audi/A8/normal/a2.jfif" alt="Slide 3" onclick="openSlide(3)">
                    <img src="../Audi/A8/normal/a3.jfif" alt="Slide 4" onclick="openSlide(4)">
                    <img src="../Audi/A8/normal/a4.jfif" alt="Slide 5" onclick="openSlide(5)">
                    <img src="../Audi/A8/normal/a5.jfif" alt="Slide 6" onclick="openSlide(6)">
                    <img src="../Audi/A8/normal/a6.jfif" alt="Slide 7" onclick="openSlide(7)">
                    <img src="../Audi/A8/normal/a7.jfif" alt="Slide 8" onclick="openSlide(8)">
                    <img src="../Audi/A8/normal/a8.jfif" alt="Slide 9" onclick="openSlide(9)">
                    <img src="../Audi/A8/normal/a9.jfif" alt="Slide 10" onclick="openSlide(10)">
                    <img src="../Audi/A8/normal/a10.jfif" alt="Slide 11" onclick="openSlide(11)">
                </div>
                
                <script>
                    function openSlide(slideNumber) {
                        const baseUrl = "A8-slideshow.html";
            ...
            <div class="left-content-down">
                <div class="right">
                    <ul>
                        ...
                        <li><strong>Fuqia:</strong> <span>333 Hp</span></li>
                        ...
                        <li><strong>Kilometrazhi:</strong> <span>50000 km</span></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="right-content">
            <div class="right-content-up">
                <p><b>Audi A8 L 55 TFSI 2020</b> është një sedan luksoz dhe i sofistikuar, i krijuar për të ofruar luks të pakrahasueshëm dhe performancë të jashtëzakonshme. Ja një përshkrim i shkurtër:

                    <br><br><b>Performanca:</b><br>
                     Motori: 3.0L V6 TFSI me 340 hp dhe 500 Nm moment rrotullimi.
                     Transmetimi: Automatik 8-shpejtësi Tiptronic, me mundësi për all-wheel drive (Quattro).
                     Shpejtësia: Arrin 0-100 km/h në 5.6 sekonda.
                    <br><br><b>Dizajni:</b><br>
                     Pamja e jashtme: Grilë frontale Singleframe, dritat Matrix LED, dhe linja të pastra që i japin një pamje të sofistikuar dhe elegante.
                    ...
                    <br><br><b>Karakteristikat:</b><br>
                     ...
                     Siguria: Audi Pre-Sense, Lane Assist, dhe Adaptive Cruise Control për një nivel të lartë sigurie dhe asistencë në vozitje.
                 </p>
...
<script>
  function redirect() {
    window.location.href = "payment.html";
                    ...
                    <div class="financing">Financim 780 €/muaj</div>
                </div>
