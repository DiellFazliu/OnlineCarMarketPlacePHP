...
<body>
    <div class="slideshow-container">
        ...
        <img class="img active" src="../Mercedes-Benz/G-class/normal/g.jfif" alt="Slide 1">
        <img class="img" src="../Mercedes-Benz/G-class/normal/g1.jfif" alt="Slide 2">
        <img class="img" src="../Mercedes-Benz/G-class/normal/g2.jfif" alt="Slide 3">
        <img class="img" src="../Mercedes-Benz/G-class/normal/g3.jfif" alt="Slide 4">
        <img class="img" src="../Mercedes-Benz/G-class/normal/g4.jfif" alt="Slide 5">
        <img class="img" src="../Mercedes-Benz/G-class/normal/g5.jfif" alt="Slide 6">
        <img class="img" src="../Mercedes-Benz/G-class/normal/g6.jfif" alt="Slide 7">
        <img class="img" src="../Mercedes-Benz/G-class/normal/g7.jfif" alt="Slide 8">
        <img class="img" src="../Mercedes-Benz/G-class/normal/g8.jfif" alt="Slide 9">
        <img class="img" src="../Mercedes-Benz/G-class/normal/g9.jfif" alt="Slide 10">
        <img class="img" src="../Mercedes-Benz/G-class/normal/g10.jfif" alt="Slide 11">
