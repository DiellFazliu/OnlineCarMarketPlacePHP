...
<body>
    <div class="slideshow-container">
        ...
        <img class="img active" src="../Mercedes-Benz/S-class/normal/s.jfif" alt="Slide 1">
        <img class="img" src="../Mercedes-Benz/S-class/normal/s1.jfif" alt="Slide 2">
        <img class="img" src="../Mercedes-Benz/S-class/normal/s2.jfif" alt="Slide 3">
        <img class="img" src="../Mercedes-Benz/S-class/normal/s3.jfif" alt="Slide 4">
        <img class="img" src="../Mercedes-Benz/S-class/normal/s4.jfif" alt="Slide 5">
        <img class="img" src="../Mercedes-Benz/S-class/normal/s5.jfif" alt="Slide 6">
        <img class="img" src="../Mercedes-Benz/S-class/normal/s6.jfif" alt="Slide 7">
        <img class="img" src="../Mercedes-Benz/S-class/normal/s7.jfif" alt="Slide 8">
        <img class="img" src="../Mercedes-Benz/S-class/normal/s8.jfif" alt="Slide 8">
        <img class="img" src="../Mercedes-Benz/S-class/normal/s9.jfif" alt="Slide 8">
        <img class="img" src="../Mercedes-Benz/S-class/normal/s10.jfif" alt="Slide 8">
