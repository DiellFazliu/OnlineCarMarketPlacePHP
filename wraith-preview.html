...
<body>
    ...
    <p id="titulli">Rolls-Royce Wraith 420 kW</p>
    <div class="logos">
        <div>
    ...
    <div class="container">
        <div class="left-content">
            <div class="left-content-up">
                <div class="slideshow">
                    <img src="../Rolls Royce/wraith/r.jpg" alt="Slide 1" class="active" onclick="openSlide(1)">
                    <img src="../Rolls Royce/wraith/r1.jpg " alt="Slide 2" onclick="openSlide(2)">
                    <img src="../Rolls Royce/wraith/r2.jpg " alt="Slide 3" onclick="openSlide(3)">
                    <img src="../Rolls Royce/wraith/r3.jpg " alt="Slide 4" onclick="openSlide(4)">
                    <img src="../Rolls Royce/wraith/r4.jpg " alt="Slide 5" onclick="openSlide(5)">
                    <img src="../Rolls Royce/wraith/r5.jpg " alt="Slide 6" onclick="openSlide(6)">
                    <img src="../Rolls Royce/wraith/r6.jpg " alt="Slide 7" onclick="openSlide(7)">
                    <img src="../Rolls Royce/wraith/r7.jpg " alt="Slide 8" onclick="openSlide(8)">
                    <img src="../Rolls Royce/wraith/r8.jpg " alt="Slide 9" onclick="openSlide(9)">
                </div>
                
                <script>
                    function openSlide(slideNumber) {
                        const baseUrl = "wraith-slideshow.html";
        ...
        <div class="right-content">
            <div class="right-content-up">
                <p><b>Rolls-Royce Wraith 420 kW</b> është një coupe luksoz që ofron një kombinim të përkryer të performancës, stilit dhe luksit. Ja një përshkrim i shkurtër:

                    <br><br><b>Performanca:</b><br>
                     Motori: 6.6L V12 me 420 kW (571 hp) dhe 850 Nm moment rrotullimi.
                    ...
                    <br><br><b>Dizajni:</b><br>
                     Pamja e jashtme: Grilë frontale elegante, linja të rrjedhshme dhe detaje të mprehta që krijojnë një pamje të fuqishme dhe të sofistikuar.
                     Pamja e brendshme: Kabinë luksoze me materialet më të mira, mbështetje të rehatshme dhe teknologji moderne që ofron një përvojë të avancuar dhe komode.
                    <br><br><b>Karakteristikat:</b><br>
                     ...
                     Siguria: Sistemi i stabilitetit të makinës, Adaptive Cruise Control, Lane Assist dhe asistencë për parkim për një përvojë sigurie dhe luks të pakrahasueshëm.
                 </p>
            </div>
            <div class="pricing-container">
                <div class="pricing-header">
                    <h2>Çmimi pa doganë</h2>
                    <div class="price">569 990€</div>
...
<script>
  function redirect() {
    window.location.href = "payment.html";
                    ...
                    <div class="financing">Financim 7200 €/muaj</div>
                </div>
