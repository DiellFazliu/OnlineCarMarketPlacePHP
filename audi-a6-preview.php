...
<body>
    ...
    <p id="titulli">Audi A6 3.0 TDI</p>
    <div class="logos">
        <div>
    ...
    <div class="container">
        <div class="left-content">
            <div class="left-content-up">
                <div class="slideshow">
                    <img src="../Audi/A6/normal/a.jfif" alt="Slide 1" class="active" onclick="openSlide(1)">
                    <img src="../Audi/A6/normal/a1.jfif" alt="Slide 2" onclick="openSlide(2)">
                    <img src="../Audi/A6/normal/a2.jfif" alt="Slide 3" onclick="openSlide(3)">
                    <img src="../Audi/A6/normal/a3.jfif" alt="Slide 4" onclick="openSlide(4)">
                    <img src="../Audi/A6/normal/a4.jfif" alt="Slide 5" onclick="openSlide(5)">
                    <img src="../Audi/A6/normal/a5.jfif" alt="Slide 6" onclick="openSlide(6)">
                    <img src="../Audi/A6/normal/a6.jfif" alt="Slide 7" onclick="openSlide(7)">
                    <img src="../Audi/A6/normal/a7.jfif" alt="Slide 8" onclick="openSlide(8)">
                </div>

                <script>
                    function openSlide(slideNumber) {
                        const baseUrl = "A6-slideshow.html";
            ...
            <div class="left-content-down">
                <div class="right">
                    <ul>
                        <li><strong>Motor:</strong> <span>2.5 V5</span></li>
                        ...
                        <li><strong>Kilometrazhi:</strong> <span>00 km</span></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="right-content">
            <div class="right-content-up">
                <p><b>Audi A6 3.0 TDI</b> është një sedan luksoz i mesëm që ofron performancë të jashtëzakonshme dhe dizajn të sofistikuar. Ja një përshkrim i shkurtër:

                    <br><br><b>Performanca:</b><br>
                     Motori: 3.0L TDI me 272 hp dhe mundësi për versionin V6 me 313 hp. Modeli quattro ofron kapacitet të shkëlqyer në terrene të ndryshme.
                    ...
                    <br><br><b>Dizajni:</b><br>
                     Pamja e jashtme: Grilë frontale single-frame, dritat LED Matrix, dhe linja elegante që japin një pamje moderne dhe dinamike.
                     Pamja e brendshme: Materiale të larta cilësie, me një ekran MMI Touch dhe opsion për Virtual Cockpit.
                    <br><br><b>Karakteristikat:</b><br>
                     Teknologji: Apple CarPlay, Android Auto, dhe mundësi për sistemin audio Bang & Olufsen.
                     Siguria: Audi Pre-Sense Plus, Park Assist dhe Adaptiv Cruise Control për siguri më të madhe.
                 </p>
            </div>
            <div class="pricing-container">
                <div class="pricing-header">
                    <h2>Çmimi pa doganë</h2>
                    <div class="price">43 423 €</div>
...
<script>
  function redirect() {
    window.location.href = "payment.html";
                    ...
                    <div class="financing">Financim 8 321 €/muaj</div>
                </div>
                <script>
