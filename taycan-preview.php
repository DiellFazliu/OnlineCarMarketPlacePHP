...
<body>
    ...
    <p id="titulli">Porsche Taycan 2022</p>
    <div class="logos">
        <div>
    ...
    <div class="container">
        <div class="left-content">
            <div class="left-content-up">
                <div class="slideshow">
                    <img src="../Porsche/taycan/p.jpg" alt="Slide 1" class="active" onclick="openSlide(1)">
                    <img src="../Porsche/taycan/p1.jpg " alt="Slide 2" onclick="openSlide(2)">
                    <img src="../Porsche/taycan/p2.jpg " alt="Slide 3" onclick="openSlide(3)">
                    <img src="../Porsche/taycan/p3.jpg " alt="Slide 4" onclick="openSlide(4)">
                    <img src="../Porsche/taycan/p4.jpg " alt="Slide 5" onclick="openSlide(5)">
                    <img src="../Porsche/taycan/p5.jpg " alt="Slide 6" onclick="openSlide(6)">
                </div>
                
                <script>
                    function openSlide(slideNumber) {
                        const baseUrl = "taycan-slideshow.html";
        ...
        <div class="right-content">
            <div class="right-content-up">
                <p><b>Porsche Taycan 2022</b> është një sedan elektrik luksoz që ofron performancë të jashtëzakonshme dhe një dizajn futuristik. Ja një përshkrim i shkurtër:

                    <br><br><b>Performanca:</b><br>
                     Motori: Dy motorrë elektrikë me 625 hp dhe 850 Nm moment rrotullimi.
                     Transmetimi: Sistemi elektrik me mundësi për all-wheel drive (AWD).
                     Shpejtësia: Arrin 0-100 km/h në 3.2 sekonda.
                    <br><br><b>Dizajni:</b><br>
                     Pamja e jashtme: Grilë moderne dhe linja të lëmuara, dritat LED të sofistikuara dhe dizajn aerodinamik për performancë maksimale.
                     Pamja e brendshme: Kabinë luksoze me materiale premium, ekran MMI Touch, dhe mundësi për Virtual Cockpit që ofron një përvojë të avancuar dhe të pasur.
                    <br><br><b>Karakteristikat:</b><br>
                     Teknologji: Apple CarPlay, Android Auto, dhe mundësi për sistemin audio Burmester.
                     Siguria: Porsche Stability Management, Adaptive Cruise Control, dhe asistencë për parkim dhe menaxhim të trafikut për një udhëtim të sigurt dhe të rehatshëm.
                 </p>
            </div>
