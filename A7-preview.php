...
<body>
    ...
    <p id="titulli">Audi A7 Sportback</p>
    <div class="logos">
        <div>
    ...
    <div class="container">
        <div class="left-content">
            <div class="left-content-up">
                <div class="slideshow">
                    <img src="../Audi/A7/normal/a.jfif" alt="Slide 1" class="active" onclick="openSlide(1)">
                    <img src="../Audi/A7/normal/a.jfif" alt="Slide 2" onclick="openSlide(2)">
                    <img src="../Audi/A7/normal/a2.jfif" alt="Slide 3" onclick="openSlide(3)">
                    <img src="../Audi/A7/normal/a3.jfif" alt="Slide 4" onclick="openSlide(4)">
                    <img src="../Audi/A7/normal/a4.jfif" alt="Slide 5" onclick="openSlide(5)">
                    <img src="../Audi/A7/normal/a5.jfif" alt="Slide 6" onclick="openSlide(6)">
                    <img src="../Audi/A7/normal/a6.jfif" alt="Slide 7" onclick="openSlide(7)">
                    <img src="../Audi/A7/normal/a7.jfif" alt="Slide 8" onclick="openSlide(8)">
                    <img src="../Audi/A7/normal/a8.jfif" alt="Slide 9" onclick="openSlide(9)">
                </div>
                
                <script>
                    function openSlide(slideNumber) {
                        const baseUrl = "A7-slideshow.html";
            ...
            <div class="left-content-down">
                <div class="right">
                    <ul>
                        ...
                        <li><strong>Fuqia:</strong> <span>300 Hp</span></li>
                        ...
                        <li><strong>Kilometrazhi:</strong> <span>28000 km</span></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="right-content">
            <div class="right-content-up">
                <p><b>Audi A7 Sportback 2021</b> është një sedan sportiv luksoz që ofron një dizajn të mahnitshëm dhe performancë të jashtëzakonshme. Ja një përshkrim i shkurtër:

                    <br><br><b>Performanca:</b><br>
                     Motori: 3.0L V6 TDI me 286 hp dhe 600 Nm moment rrotullimi, ose 3.0L V6 TFSI me 340 hp.
                     Transmetimi: Automatik 7-shpejtësi S tronic, me mundësi për all-wheel drive (Quattro).
                     Shpejtësia: Arrin 0-100 km/h në 5.2 sekonda (për versionin V6 TFSI).
                    <br><br><b>Dizajni:</b><br>
                     Pamja e jashtme: Grilë frontale Singleframe, dritat Matrix LED, dhe linja të mprehta që i japin një pamje dinamike dhe elegante.
                     Pamja e brendshme: Materiale premium, ekran MMI Touch, dhe opsion për Virtual Cockpit që ofron një pamje moderne dhe të pastër.
...
<script>
  function redirect() {
    window.location.href = "payment.html";
                    ...
                    <div class="financing">Financim 650 €/muaj</div>
                </div>
