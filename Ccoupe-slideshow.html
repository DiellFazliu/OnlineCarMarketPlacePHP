...
<body>
    <div class="slideshow-container">
        ...
        <img class="img active" src="../Mercedes-Benz/C-class/coupe/c.jfif" alt="Slide 1">
        <img class="img" src="../Mercedes-Benz/C-class/coupe/c1.jfif" alt="Slide 2">
        <img class="img" src="../Mercedes-Benz/C-class/coupe/c2.jfif" alt="Slide 3">
        <img class="img" src="../Mercedes-Benz/C-class/coupe/c3.jfif" alt="Slide 4">
        <img class="img" src="../Mercedes-Benz/C-class/coupe/c4.jfif" alt="Slide 5">
        <img class="img" src="../Mercedes-Benz/C-class/coupe/c5.jfif" alt="Slide 6">
        <img class="img" src="../Mercedes-Benz/C-class/coupe/c6.jfif" alt="Slide 7">
        <img class="img" src="../Mercedes-Benz/C-class/coupe/c7.jfif" alt="Slide 8">
