...
<body>
    <div class="slideshow-container">
        ...
        <img class="img active" src="../Porsche/taycan/p.jpg" alt="Slide 1">
        <img class="img" src="../Porsche/taycan/p1.jpg" alt="Slide 2">
        <img class="img" src="../Porsche/taycan/p2.jpg" alt="Slide 3">
        <img class="img" src="../Porsche/taycan/p3.jpg" alt="Slide 4">
        <img class="img" src="../Porsche/taycan/p4.jpg" alt="Slide 5">
        <img class="img" src="../Porsche/taycan/p5.jpg" alt="Slide 6">
