    ...
    <div class="container">
        <div class="left-content">
            <div class="left-content-up">
                <div class="slideshow">
                    <img src="../BMW/M4/coupe/b.jpg" alt="Slide 1" class="active" onclick="openSlide(1)">
                    <img src="../BMW/M4/coupe/b1.jpg" alt="Slide 2" onclick="openSlide(2)">
                    <img src="../BMW/M4/coupe/b2.jpg" alt="Slide 3" onclick="openSlide(3)">
                    <img src="../BMW/M4/coupe/b3.jpg" alt="Slide 4" onclick="openSlide(4)">
                    <img src="../BMW/M4/coupe/b4.jpg" alt="Slide 5" onclick="openSlide(5)">
                    <img src="../BMW/M4/coupe/b5.jpg" alt="Slide 6" onclick="openSlide(6)">
                    <img src="../BMW/M4/coupe/b6.jpg" alt="Slide 7" onclick="openSlide(7)">
                    <img src="../BMW/M4/coupe/b7.jpg" alt="Slide 8" onclick="openSlide(8)">
                    <img src="../BMW/M4/coupe/b8.jpg" alt="Slide 9" onclick="openSlide(9)">
                    <img src="../BMW/M4/coupe/b9.jpg" alt="Slide 10" onclick="openSlide(10)">
                    <img src="../BMW/M4/coupe/b10.jpg" alt="Slide 11" onclick="openSlide(11)">
                    <img src="../BMW/M4/coupe/b11.jpg" alt="Slide 12" onclick="openSlide(12)">
                    <img src="../BMW/M4/coupe/b12.jpg" alt="Slide 13" onclick="openSlide(13)">
                </div>
                
                <script>
                    function openSlide(slideNumber) {
                        const baseUrl = "BMW4-slideshow.html";
        ...
        <div class="right-content">
            <div class="right-content-up">
                <p><b>BMW M4 G82</b> është një coupe sportiv i jashtëzakonshëm që ofron performancë të papërshkrueshme dhe dizajn të mprehtë. Ja një përshkrim i shkurtër:
                    ...
                    <br><br><b>Dizajni:</b><br>
                     Pamja e jashtme: Grilë frontale më të gjërë, dritat LED, dhe elementë aerodinamikë që ofrojnë një pamje agresive dhe të sofistikuar.
                     Pamja e brendshme: Kabinë me detaje sportive dhe premium, sedilje sportivë, dhe ekran i avancuar i komandave dhe infotainment.
                    <br><br><b>Karakteristikat:</b><br>
                     Teknologji: Apple CarPlay, Android Auto, dhe mundësi për sistemin audio Harman Kardon.
                     Siguria: M Drive, Dynamic Traction Control, dhe asistentë të avancuar për siguri të lartë dhe përvojë të jashtëzakonshme drejtimi.
                 </p>
            </div>
